...
//dd($datos_funcionario);
    ...
    public function ver_pendientes(Request $request)
    {
       ...
       return view('rrhh.vacaciones.vacaciones_pendientes',compact('cedula','nacionalidades','datos_funcionario','edad','tipo_trabajador','uni_adscripcion','tipo_mov'));
    } 
    ...
    public function ver_aprobadas(Request $request)
    {
       ...
       return view('rrhh.vacaciones.vacaciones_aprobadas',compact('cedula','nacionalidades','datos_funcionario','edad','tipo_trabajador','uni_adscripcion','tipo_mov'));
    } 
    public function ver_pendientes_aprobar(Request $request)
    {
       ...
       return view('rrhh.vacaciones.vacaciones_pendientes_aprobar',compact('cedula','nacionalidades','datos_funcionario','edad','tipo_trabajador','uni_adscripcion','tipo_mov'));
    } 
    public function aprobacion(Request $request)
    {
       ...
       return view('rrhh.vacaciones.aprobar_solicitud',compact('cedula','nacionalidades','datos_funcionario','edad','tipo_trabajador','uni_adscripcion','tipo_mov'));
    } 
