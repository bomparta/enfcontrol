...
<body>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}">Productos&nbsp;<i class="fa fa-box"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}">Vender&nbsp;<i class="fa fa-cart-plus"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('home')}}">Ventas&nbsp;<i class="fa fa-list"></i></a>
                </li>
    ...
    document.addEventListener("DOMContentLoaded", () => {
     ...
     <span class="text-muted">Sistema de control de estudio de la Escuela Nacional de Fiscales. 
        ...
        con
        <i class="fa fa-code text-white">Colmenare</i>
        por
