                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('update.periodo',$periodos->id) }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input  id="nombre" type="text" class="form-control rounded-pill border-primary @error('nombre') is-invalid @enderror" name="nombre" value="{{ $periodos->nombre}}" >
                                                @error('nombre')
                                            ...
                                            <div class="form-group">
                                                ...
                                                @else 
                                                    ...
                                                    <input type="radio" name="estatus" value="0" checked> Inactivo 
                                                @endif
                                                    
                                            </div>
                                            <div class="form-group">
                                                <label for="condicion">Condicion  :</label>
                                                @if($periodos->condicion == 1)
                                                    <input type="radio" name="condicion" value="1" checked> Abierto
                                                    <input type="radio" name="condicion" value="0"> Cerrado
                                                @else
                                                    <input type="radio" name="condicion" value="1" > Abierto
                                                    <input type="radio" name="condicion" value="0" checked> Cerrado
                                                @endif
