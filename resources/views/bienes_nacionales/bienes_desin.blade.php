...
@include('layouts.appbienes')  
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
          ...
          <table> 
          <form id="formulario" name="formulario" method="POST" action="{{route('registrar_desin_bienes')}}">     
              
          @foreach ($bienes as $key=>$item)  
         <input id="id_bien" type="text" name="id_bien" value="{{$item->id_bien}}" >
          ...
          @csrf
            ...
            <tr>
                ...
                <td>
                    ...
                    <select id="tipo_movimiento" name="tipo_movimiento"class="form-control"    required >
                                ...
                                <option value="6" selected >Desincorporación</option>                  
            ...
            <tr>
                <td>
                    ...
                    <select id="ubic_adm" name="ubic_adm"class="form-control"   readonly required >
                         <option value="0">Seleccione...</option>                                 
                        <option value="1" @if($item->ubic_adm_id == '1')selected @endif > Coordinación de Administración y Servicios</option>
                        <option value="2" @if($item->ubic_adm_id == '2')selected @endif > Dirección de Gestión Interna</option>
                        <option value="3" @if($item->ubic_adm_id == '3')selected @endif> Dirección de Promoción y Difusión</option>     
                        <option value="4" @if($item->ubic_adm_id == '4')selected @endif> Coordinación de Contrataciones </option>                                     
                    </select>                        
                </td>
                <td>
                &nbsp;Ubicación Geográfica&nbsp;<span style="color:red;">*</span>&nbsp;
                    <select id="ubic_geo" name="ubic_geo"class="form-control"   readonly required >
                        <option value="0">Seleccione...</option>   
            ...
            <tr>  
                <td>
                    ...
                    <input type="text" class="form-control " name="responsable_asignado" id="responsable_asignado" readonly value="{{$item->responsable_asignado}}"  maxlength="100"  required/>                        
                </td>
                <td >
                    &nbsp;Observaciones  &nbsp;&nbsp;&nbsp;&nbsp;
                    <textarea rows="2" class="form-control"  name="observaciones" id="observaciones" maxlength="200"  readonly >{{$item->observaciones}} </textarea>
                </td>
            </tr>    
            @endforeach                     
        </table>
