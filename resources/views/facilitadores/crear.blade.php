            ...
            <div class="container pb-4">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                @include('layouts.items.card-header', ['titulo' => 'Agregar Facilitadores a la Actuación codigo y nombre??'])
                                ...
                                <input type="hidden" name="id_actuacion" value="{{$id}}" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group-sm col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group-sm col-lg-2 col-md-2 col-sm-4 col-xs-12">
                                            <label for="funcionario" class="control-label">Tratamiento</label>
                                                    ...
                                                    <div id="txt_nuevo" style="display:none;">
                                                        <b>Nuevo participante.</b>
                                                            ...
                                                            <div align="center">
                                                                ...
                                                                <a class='btn btn-default' href="{{URL::route('actuacion')}}">Cerrar</a>
                                                            </div>
