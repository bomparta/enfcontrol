                    ...
                    <table align="center" border="0" cellpadding="2" cellspacing="2" width="100%" >
                        ...
                        <tr>
                            <td>
                                ...
                                <input id="primernombre" type="text"  maxlength="25" class="form-control @error('primernombre') is-invalid @enderror" name="primernombre" value="{{ $datos[0]->nombre_primer }}" required>
                                @error('primernombre')
                            ...
                            <td>
                                ...
                                <input id="segundonombre" type="text"  maxlength="25" class="form-control @error('segundonombre') is-invalid @enderror" name="segundonombre" value="{{ $datos[0]->nombre_segundo }}" required>
                                @error('segundonombre')
                                    <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                    </div>
                        ...
                        <tr>
                            <td>
                                ...
                                <input id="primerapellido" type="text"  maxlength="25" class="form-control @error('primerapellido') is-invalid @enderror" name="primerapellido" value="{{ $datos[0]->apellido_primer }}" required>
                            ...
                            <td>
                                ...
                                <input id="segundoapellido" type="text"  maxlength="25" class="form-control @error('segundoapellido') is-invalid @enderror" name="segundoapellido" value="{{ $datos[0]->apellido_segundo }}" required>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="cedula" id="cedula" value="{{ $datos[0]->cedula }}"  maxlength="12"/>
                                @error('cedula')
                                    <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="correo" type="email"  maxlength="250" class="form-control @error('correo') is-invalid @enderror" name="correo" value="{{ $datos[0]->correo }}" required>
                                @error('correo')
                                    <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                    </div>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" name="telfhabitacion" id="telfhabitacion" value="{{ $datos[0]->tel_habitacion }}"  maxlength="100"/>
                            </td>
                            <td>
                                &nbsp;Fecha Nacimiento&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">*</span><br>
                                <input type="date" name="fechanac" id="fechanac" value="{{ $datos[0]->fecha_nac }}"  maxlength="25" required/>
                            </td>
                        </tr>
                        <!-- FILA 6 -->
                        <tr>
                            <td>
                                ...
                                <input type="text" name="telefonoCel" id="telefonoCel" value="{{ $datos[0]->tel_celular }}" style="width:190px;" maxlength="11" onKeyPress="return valText(this.value, event, 'int');"  class="campoTexto" required/>
                            </td>
                            <td>
                                ...
                                <input type="text" name="telfwhatsapp" id="telfwhatsapp" value="{{ $datos[0]->telefono_whatsapp }}" style="width:190px;" maxlength="100" required/>
                            </td>
                        </tr>
                    </table>
